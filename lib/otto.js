(function () {
    ...
    var Otto = (function () {
        ...
        function Otto(root, config, choices) {
            ...
            this.setRedrawTimer = function () {
                ...
                this.redrawTimer = setTimeout(function () {
                    ...
                    var offsetTop = rootRect.top;
                    var offsetLeft = rootRect.left;

                    this.dropDown.style.width = (this.root.offsetWidth).toString() + 'px';
                    this.dropDown.style.top = (this.root.offsetHeight + offsetTop + 2).toString() + 'px';
        ...
        function Dropdown(root, customClass) {
            ...
            dropDown.style.top = (root.offsetHeight + offsetTop + 2).toString() + 'px';
